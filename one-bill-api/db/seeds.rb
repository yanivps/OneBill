...
User.create!(name: 'Test User', email: 'test@email.com', password: 'test1234')
...
account = Account.new(account_number: "2", owner_name: "#{Faker::Name.first_name} #{Faker::Name.last_name}",
